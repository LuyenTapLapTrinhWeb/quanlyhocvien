var app = angular.module("myApp",["ngRoute","ngMessages","ngFileUpload"]);
...
app.config(function($routeProvider){
  ...
  .when('/menu_Class',{
	...
	.when('/menu_Lecturers',{
    templateUrl: 'page/menu_Lecturers.html'
  })
	.when('/menu_Classrom',{
    templateUrl: 'page/menu_Classrom.html'
  })
	.when('/menu_Studentprofile',{
    templateUrl: 'page/menu_Studentprofile.html'
  }) 
	.when('/menu_Studentstatus',{
    templateUrl: 'page/menu_Studentstatus.html'
  })  
  	.when('/menu_Students',{
    templateUrl: 'page/menu_Students.html'
  })
   .when('/menu_COS', {
      templateUrl: 'page/menu_COS.html'
    }) 
});
